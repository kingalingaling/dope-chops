...
const Register = () => {
  ...
  return (
    <div className="h-full text-white">
      ...
      <div className={login ? "g-6 flex h-full flex-wrap items-center justify-center lg:justify-between" : "g-6 flex h-full flex-row-reverse pl-6 duration-150 transition-opacity ease-linear items-center justify-center lg:justify-between"}>
          ...
          <form>
            ...
            <div className="flex flex-row items-center justify-center lg:justify-start">
              ...
              <button
                ...
                className="inlne-block mx-1 h-9 w-9 rounded-full bg-white uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca]"
