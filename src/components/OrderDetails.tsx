  ...
  return (
    props.show && (
      <div className="flex flex-col justify-center items-center">
        ...
        {confirm ? (
          <div className="flex fixed w-3/4 mx-auto border-none bg-red-700 text-white p-4 rounded-2xl my-auto z-30 flex-col justify-center items-center">
        ...
        <div className="fixed top-32 md:top-1/4 mx-auto my-auto z-20 border-black bg-gray-800 text-white shadow-xl duration-300 rounded-lg p-4 w-4/5 sm:w-[600px]">
          <div className="flex flex-col justify-between px-2 py-3">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <h2 className="font-bold lg:text-lg text-orange-600">
                {order.id}
              </h2>
              <button
                className="border border-white p-1 bg-white text-black hover:bg-red-600 hover:text-white hover:border-red-600  rounded-xl w-[50px]"
